...
import oop.abstraction.abstractClasses.entities.AbstractShape;
...
public class AreaCalculation {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++){
            ...
            if(tip == 'c' || tip == 'C'){
                System.out.print("Qual a cor do seu circulo (Black, Blue, Red, White): ");
                ...
                System.out.print("Qual a cor do seu retângulo (Black, Blue, Red, White): ");
                String color = sc.nextLine();
